...
TEST(OpCodeMulti, test_offset_out_of_range)
{
    OpCodeMulti opCode( 0x80);
...
TEST(OpCodeMulti, test_truncated_instruction)
{
    OpCodeMulti opCode( 0x80);
...
TEST(OpCodeMulti, test_truncated_instruction2)
{
    OpCodeMulti opCode(0x80);
...
TEST(OpCodeMulti, test_register2register)
{
    OpCodeMulti opCode(0x80);
...
TEST(OpCodeMulti, test_register2pointer)
{
    OpCodeMulti opCode(0);
...
TEST(OpCodeMulti, test_register2pointerWithData)
{
    OpCodeMulti opCode(0);
